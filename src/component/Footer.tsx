...
const Footer = () => {
  ...
  return (
    <footer ref={containerRef} className="bg-carbon-black text-platinum overflow-hidden rounded-t-[40px] md:rounded-t-[60px] border-t-8 border-amber-flame mt-20 relative">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-8 lg:px-12 py-12 md:py-20 relative z-10">
        ...
        <div className="mt-12 md:mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 md:pb-20">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="font-display text-xl md:text-2xl font-bold text-sapphire mb-4 md:mb-6">Product</h4>
            <ul className="space-y-3 md:space-y-4 font-medium text-base md:text-lg opacity-80">
              <li><a href="#" className="hover:text-amber-flame hover:underline decoration-4 transition-all">Features</a></li>
              <li><Link href="/pricing" className="hover:text-amber-flame hover:underline decoration-4 transition-all">Pricing</Link></li>
            </ul>
          </div>

          {/* Support Links */}
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="font-display text-xl md:text-2xl font-bold text-sapphire mb-4 md:mb-6">Support</h4>
            <ul className="space-y-3 md:space-y-4 font-medium text-base md:text-lg opacity-80">
              <li><Link href="/contact" className="hover:text-cool-horizon hover:underline decoration-4 transition-all">Contact</Link></li>
              <li className="relative">
                <button 
                  ...
                  className="hover:text-cool-horizon hover:underline decoration-4 transition-all cursor-pointer"
                >
                  Community
                </button>
                {showCommunityBadge && (
                  <div className="absolute -top-12 left-1/2 -translate-x-1/2 sm:left-0 sm:translate-x-0 z-30 bg-amber-flame text-carbon-black px-4 py-2 rounded-xl border-4 border-carbon-black font-display font-black uppercase text-xs sm:text-sm shadow-[4px_4px_0px_rgba(26,26,26,1)] rotate-[-10deg] animate-[bounce_0.5s_infinite] whitespace-nowrap">
                    Coming Soon! 🚀
                  </div>
                )}
              </li>
          ...
          {/* Company Links */}
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="font-display text-xl md:text-2xl font-bold text-sapphire mb-4 md:mb-6">Company</h4>
            <ul className="space-y-3 md:space-y-4 font-medium text-base md:text-lg opacity-80">
              <li><Link href="/privacy" className="hover:text-sapphire hover:underline decoration-4 transition-all">Privacy</Link></li>
            </ul>
          </div>
        </div>

        {/* Footer Bottom */}
        <div className="flex flex-col gap-10 border-t-2 border-platinum/20 pt-10 sm:flex-row sm:items-center sm:justify-between text-center sm:text-left">
