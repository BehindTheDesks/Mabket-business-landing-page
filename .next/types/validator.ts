...
// Validate ../../src/app/api/contact/send/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/contact/send">> = Specific
  const handler = {} as typeof import("../../src/app/api/contact/send/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/waitlist/send/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/waitlist/send">> = Specific
  const handler = {} as typeof import("../../src/app/api/waitlist/send/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
